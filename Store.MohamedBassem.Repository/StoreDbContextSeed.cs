    ...
    public class StoreDbContextSeed
    {
        public async static Task SeedAsync(StoreDbContext _context)
        {
            if (_context.Brands.Count() == 0)
            {
                ...
                var brandData = File.ReadAllText(@"..\Store.MohamedBassem.Repository\Data\DataSeed\brands.josn");
            ...
            if (_context.Types.Count() == 0)
            {
                ...
                var typesData = File.ReadAllText(@"..\Store.MohamedBassem.Repository\Data\DataSeed\types.josn");
            ...
            if (_context.Products.Count() == 0)
            {
                ...
                var productsData = File.ReadAllText(@"..\Store.MohamedBassem.Repository\Data\DataSeed\products.josn");
